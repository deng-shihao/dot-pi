 ...
 *
 * Replaces the built-in header with a gradient "pi" ASCII-art logo and
 * enriches the footer with model usage stats, git status, and extension
 * status lines.
 *
...
const BOLD = "\x1b[1m";
const PALETTE: Rgb[] = [
  // Catppuccin Mocha gradient: blue → lavender → mauve (accent) → pink
  [137, 180, 250],  // blue
